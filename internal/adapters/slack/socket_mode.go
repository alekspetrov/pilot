...
// RawSocketEventType identifies the kind of raw envelope received over Socket Mode.
...
// from the Slack Socket Mode WebSocket connection. This is the low-level
// envelope; use parseEnvelope() in events.go for higher-level SocketEvent.
